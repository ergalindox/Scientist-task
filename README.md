...
For further data analysis refer to the Buynomics_Notebook.ipynb inside the notebooks folder.

## 3. Data Description
**Dataset:** For running this project, it is needed two datasets, one the product.csv and the other the sales.csv.
Make sure to have attached this datasets into the data folder.
...
3. Run the model_selection.py file.
4. Run the prediction.py file.
5. When prompted, enter a price adjustment (e.g., 120 for +20%).
6. Review printed results and charts.
